...
function BrandLoginPage({ onLoginSuccess }) {
  ...
  return (
    <div className="login-container">
      <form onSubmit={handleLogin}>
        <h1>Brand Portal</h1>
        <p>Log in to manage your campaigns.</p>
        ...
        <p style={{marginTop: '20px'}}>
          Don't have an account? <Link to="/brand/signup">Sign Up</Link>
        </p>
